...
- Categories: Use exact category names provided above
`;
...
export function validateCompanyInsights(data) {
  ...
  for (const insight of insights) {
    if (insight.category && insight.headline && insight.detail && insight.impact && 
      ...
      console.log(`❌ Invalid insight missing fields:`, insight);
    }
  }
  
  console.log(`Insights validation: ${validInsights}/${insights.length} valid insights`);
