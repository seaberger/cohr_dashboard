...
export const UniversalMetricsSchema = z.object({
  ...
  grossMargin: UniversalMetricSchema,
  operatingMargin: UniversalMetricSchema,
  freeCashFlow: UniversalMetricSchema,
  rdRatio: UniversalMetricSchema,
  roic: UniversalMetricSchema,
  debtToEquity: UniversalMetricSchema,
  cashAndInvestments: UniversalMetricSchema
});
